...
!      
       ...
       INTEGER MPI_REAL2
       PARAMETER (MPI_REAL2=MPI_DATATYPE_NULL)
       INTEGER MPI_REAL4
       ...
       PARAMETER (MPI_COMPLEX4=MPI_DATATYPE_NULL)
       ...
       PARAMETER (MPI_SESSION_NULL=939524096)
       ...
       PARAMETER (MPI_ERRORS_ABORT=1409286147)
       ...
       PARAMETER (MPI_MAX_STRINGTAG_LEN=255)
       INTEGER MPI_MAX_PSET_NAME_LEN
       PARAMETER (MPI_MAX_PSET_NAME_LEN=255)
       ...
       PARAMETER (MPI_COMBINER_VALUE_INDEX=20)
       INTEGER MPI_ORDER_C
       ...
       PARAMETER (MPI_COMM_TYPE_HW_GUIDED=2)
       INTEGER MPI_COMM_TYPE_HW_UNGUIDED
       PARAMETER (MPI_COMM_TYPE_HW_UNGUIDED=3)
       INTEGER MPI_COMM_TYPE_RESOURCE_GUIDED
       PARAMETER (MPI_COMM_TYPE_RESOURCE_GUIDED=4)
       ...
       INTEGER MPI_SOURCE
       PARAMETER (MPI_SOURCE=3)
       INTEGER MPI_TAG
       PARAMETER (MPI_TAG=4)
       INTEGER MPI_ERROR
       PARAMETER (MPI_ERROR=5)
       ...
       EXTERNAL MPI_WTIME, PMPI_WTIME
       REAL*8 MPI_WTIME, PMPI_WTIME
       EXTERNAL MPI_WTICK, PMPI_WTICK
       REAL*8 MPI_WTICK, PMPI_WTICK
       EXTERNAL MPI_AINT_ADD, PMPI_AINT_ADD
       INTEGER(KIND=MPI_ADDRESS_KIND) MPI_AINT_ADD, PMPI_AINT_ADD
       EXTERNAL MPI_AINT_DIFF, PMPI_AINT_DIFF
       INTEGER(KIND=MPI_ADDRESS_KIND) MPI_AINT_DIFF, PMPI_AINT_DIFF
       ...
       SAVE /MPIFCMB5/, /MPIFCMB9/, /MPIFCMBa/
       SAVE /MPIPRIV1/, /MPIPRIV2/, /MPIPRIVC/
