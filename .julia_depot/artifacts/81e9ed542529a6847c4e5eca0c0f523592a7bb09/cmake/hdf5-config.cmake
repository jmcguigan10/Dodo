...
set (${HDF5_PACKAGE_NAME}_INSTALL_MOD_FORTRAN "SHARED")
#-----------------------------------------------------------------------------
# Features:
#-----------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------
set (${HDF5_PACKAGE_NAME}_ENABLE_MAP_API        ON)
set (${HDF5_PACKAGE_NAME}_ENABLE_DIRECT_VFD     OFF)
set (${HDF5_PACKAGE_NAME}_ENABLE_MIRROR_VFD     ON)
set (${HDF5_PACKAGE_NAME}_ENABLE_ROS3_VFD       ON)
set (${HDF5_PACKAGE_NAME}_ENABLE_HDFS_VFD       OFF)
set (${HDF5_PACKAGE_NAME}_ENABLE_SUBFILING_VFD  ON)
set (${HDF5_PACKAGE_NAME}_ENABLE_PLUGIN_SUPPORT OFF)
#-----------------------------------------------------------------------------
set (${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS       OFF)
set (${HDF5_PACKAGE_NAME}_EXPORT_LIBRARIES      hdf5-shared;hdf5_tools-shared;hdf5_hl-shared;hdf5_f90cstub-shared;hdf5_fortran-shared;hdf5_hl_f90cstub-shared;hdf5_hl_fortran-shared;hdf5_cpp-shared;hdf5_hl_cpp-shared)
...
if (${HDF5_PACKAGE_NAME}_ENABLE_PARALLEL)
  set (${HDF5_PACKAGE_NAME}_MPI_C_INCLUDE_PATH "/workspace/aarch64-apple-darwin20-libgfortran5-cxx11-mpi+mpich/destdir/include;/opt/aarch64-apple-darwin20/aarch64-apple-darwin20/sys-root/usr/local/include")
  set (${HDF5_PACKAGE_NAME}_MPI_C_LIBRARIES    "/opt/aarch64-apple-darwin20/aarch64-apple-darwin20/sys-root/usr/local/lib/libmpi.dylib;/opt/aarch64-apple-darwin20/aarch64-apple-darwin20/sys-root/usr/local/lib/libpmpi.dylib")
  if (${HDF5_PACKAGE_NAME}_BUILD_FORTRAN)
    set (${HDF5_PACKAGE_NAME}_MPI_Fortran_INCLUDE_PATH "/workspace/aarch64-apple-darwin20-libgfortran5-cxx11-mpi+mpich/destdir/include;/opt/aarch64-apple-darwin20/aarch64-apple-darwin20/sys-root/usr/local/include")
    set (${HDF5_PACKAGE_NAME}_MPI_Fortran_LIBRARIES    "/opt/aarch64-apple-darwin20/aarch64-apple-darwin20/sys-root/usr/local/lib/libmpifort.dylib;/opt/aarch64-apple-darwin20/aarch64-apple-darwin20/sys-root/usr/local/lib/libmpi.dylib;/opt/aarch64-apple-darwin20/aarch64-apple-darwin20/sys-root/usr/local/lib/libpmpi.dylib")
  endif ()
