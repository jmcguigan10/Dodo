...
foreach(_expectedTarget hdf5-shared mirror_server mirror_server_stop hdf5_tools-shared h5diff ph5diff h5ls h5debug h5repart h5mkgrp h5clear h5delete h5import h5repack h5jam h5unjam h5copy h5stat h5dump h5format_convert h5perf_serial h5perf hdf5_hl-shared h5watch hdf5_f90cstub-shared hdf5_fortran-shared hdf5_hl_f90cstub-shared hdf5_hl_fortran-shared hdf5_cpp-shared hdf5_hl_cpp-shared)
...
set_target_properties(hdf5-shared PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "\$<\$<PLATFORM_ID:Windows>:>;\$<\$<NOT:\$<PLATFORM_ID:Windows>>:>;\$<\$<BOOL:ON>:MPI::MPI_C>;\$<\$<OR:\$<BOOL:>,\$<BOOL:ON>>:Threads::Threads>"
)
